...
public class DashRendererBuilder implements DemoPlayer.RendererBuilder {
    ...
    private static final class AsyncRendererBuilder
        ...
        private void buildRenderers() {
            ...
            DataSource dataSource2 = new DefaultUriDataSource(context, bandwidthMeter, userAgent);
            CacheDataSource cacheDataSource = new CacheDataSource(cache, dataSource2, false, false);
            /****************/
